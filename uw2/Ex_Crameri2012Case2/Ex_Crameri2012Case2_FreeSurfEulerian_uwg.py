...
ymin, ymax = ndim(-700 * u.kilometer), ndim(150 * u.kilometer)
yint = 0.
...
use_fssa = False
if use_fssa:
    outputPath = "op_Ex_Crameri2012Case2_FreeSurf_Eulerian_withFSSA0.5_yres{:n}_uwg".format(yRes)

else:
    outputPath = "op_Ex_Crameri2012Case2_FreeSurf_Eulerian_noFSSA_yres{:n}_uwg".format(yRes)
