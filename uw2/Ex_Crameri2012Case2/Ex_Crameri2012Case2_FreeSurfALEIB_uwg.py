...
use_fssa = False
if use_fssa:
    outputPath = "op_Ex_Crameri2012Case2_FreeSurf_ALEIB_withFSSA0.5_yres{:n}_uwg".format(yRes)

else:
    outputPath = "op_Ex_Crameri2012Case2_FreeSurf_ALEIB_noFSSA_yres{:n}_uwg".format(yRes)
