...
# WBL0 = 0.1  #ndim(100*u.kilometer)  # or 90? 
# thcrust = 0.01 
# slab_theta = 30
# slab_length = 0.5
...
#Air.capacity   = 1200. * u.joule / (u.kelvin * u.kilogram)
...
#halfSpaceTemp = (Temp_bot-Temp_surf)*fn.math.erf((1.-depthFn)/platethickness)+Temp_surf
halfSpaceTemp = (Temp_bot-Temp_surf)*fn.math.erf((depthFn)/platethickness)+Temp_surf
#halfSpaceTemp = Temp0*fn.math.erf((depthFn)/platethickness)
...
# Fig.Contours(Model.mesh, GEO.dimensionalise(Model.temperature, u.degK), interval= 300, limits=( 300,1600.),colours='Black', colourBar=False)
# Fig.show()
...
# tleft = Model.temperature.data[Model.left_wall]*KT.m
# dleft = Model.mesh.data[Model.left_wall,1]*KL.m
# plt.plot(dleft,tleft)
...
# Model.run_for(0.01 * u.megayears, checkpoint_interval=2500*u.year,dt=2500*u.year)
