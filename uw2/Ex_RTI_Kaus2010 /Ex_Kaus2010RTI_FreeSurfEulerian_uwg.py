...
use_fssa = False
if use_fssa:
    outputPath = "op_Ex_Kaus2010RTI_FreeSurfEulerian_withFSSA0.5_yres{:n}_uwg".format(yRes)
else:
    outputPath = "op_Ex_Kaus2010RTI_FreeSurfEulerian_noFSSA_yres{:n}_uwg".format(yRes)
