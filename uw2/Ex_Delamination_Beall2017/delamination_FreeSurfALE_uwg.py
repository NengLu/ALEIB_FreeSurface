...
use_fssa = False
if use_fssa:
    outputPath = "op_delamination_Fsurf_ALE_withFSSA0.5_yres{:n}_uwg".format(yRes)
else:
    outputPath = "op_delamination_Fsurf_ALE_noFSSA_yres{:n}_uwg".format(yRes)
...
Model.run_for(1.1e5*u.year, checkpoint_interval=1e4*u.year,dt=2500*u.year)
